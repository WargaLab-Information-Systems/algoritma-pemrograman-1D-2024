...
jenis_keanggotaan_input = jenis_keanggotaan_input.lower()
...
# += adalah menambahkan diskon yang ada seperti belanja lebih 1.000.000 maka akan mendapatkan diskon %5