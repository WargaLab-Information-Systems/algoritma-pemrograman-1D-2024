...
def cari_karyawan(data_karyawan):
    ...
    hasil = []
    for karyawan in data_karyawan:
        if karyawan[jenis].lower() == nilai.lower():
...
def edit_karyawan():
    ...
    pilihan = input("Pilih nomer yang ingin di ubah : ")
    ...
    data_karyawan[pilihan - 1]["NIP"] = nip_baru
    data_karyawan[pilihan - 1]["Nama"] = nama_baru
    data_karyawan[pilihan - 1]["Alamat"] = alamat_baru
    data_karyawan[pilihan - 1]["Departemen"] = dep_baru
    data_karyawan[pilihan - 1]["Jabatan"] = jab_baru
    print("\n Berhasil mengubah...")
    print()
