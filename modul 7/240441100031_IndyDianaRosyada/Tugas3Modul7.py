...
def perbarui_data_siswa(kelas_list, nama_lama, nama_baru=None, sekolah_baru=None, plot_baru=None):
    ...
    ditemukan = False # Ketika fungsi menemukan siswa yang namanya cocok dengan nama_lama, variabel ditemukan diubah menjadi True
    for kelas in kelas_list:
        for siswa in kelas['siswa']:
    ...
    while True:
        ...
        if pilihan == '1':
            while True:
                ...
                if not nama:
                    print("Nama siswa tidak boleh kosong. Silakan masukkan nama siswa.")
                else:
                    break
            ...
            while True:
                ...
                if not sekolah:
                    print("Asal sekolah tidak boleh kosong. Silakan masukkan asal sekolah.")
                else:
                    break
            ...
            while True:
                ...
                if not plot:
                    print("Plot bimbingan tidak boleh kosong. Silakan masukkan plot bimbingan.")
                else:
                    break
